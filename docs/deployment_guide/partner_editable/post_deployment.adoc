...
image::../docs/deployment_guide/images/qs-step9-connie-clustering.png[]
...
image::../docs/deployment_guide/images/qs-collabediting-step1.png[]
...
+
.Change editing mode
image::../docs/deployment_guide/images/qs-collabediting-step2.png[]
. Verify that collaborative editing is on and that the status of Synchrony is *Running*.
+
.Collaborative editing (on)
image::../docs/deployment_guide/images/qs-collabediting-step3.png[]
