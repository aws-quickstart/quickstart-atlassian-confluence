...
This Quick Start deploys a cluster-ready infrastructure for {partner-product-name-short}. This requires a {partner-product-name} license. See the https://www.atlassian.com/software/jira/pricing?tab=self-managed[Atlassian pricing page] for licensing information.
